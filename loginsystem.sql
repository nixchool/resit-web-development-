...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1639967932ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.3" media="print" id="printcss">
    <title>localhost:8080 / 127.0.0.1:3307 | phpMyAdmin 5.1.3</title>
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=loginsystem&table=staff_record">`loginsystem`.`staff_record`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=loginsystem&table=users">`loginsystem`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4b50604e222e637047656443424c784b">
...
<nav id="server-breadcrumb" aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item">
      ...
      <a href="index.php?route=/" data-raw-text="127.0.0.1:3307">
...
<div id="topmenucontainer" class="menucontainer">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="loginsystem" targettable="">
 ...
 PRIMARY KEY (`id`)
                            ...
                            targetdb="loginsystem" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="loginsystem" targettable="staff_record">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `loginsystem`.`staff_record` ( `sn` INT(20) NOT NULL AUTO_INCREMENT ,  `staff_id` VARCHAR(9) NOT NULL ,  `full_name` INT(60) NOT NULL ,  `intruments` INT(50) NOT NULL ,    PRIMARY KEY  (`sn`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="loginsystem" targettable="staff_record">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `staff_record` WHERE 1;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="loginsystem" targettable="staff_record">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `staff_record`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="loginsystem" targettable="staff_record">
                            <div class="action_content">
